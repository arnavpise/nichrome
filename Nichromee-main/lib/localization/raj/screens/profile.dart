...
class Profile extends StatefulWidget {
  ...
  @override
  State<Profile> createState() => _ScanState();
}

class _ScanState extends State<Profile> {
  File? _image;
  ...
  Future<void> uploadImage(File image) async {
    var uri = Uri.parse('https://red-badgers-decide.loca.lt'); // Replace with your local IP address
    // var uri = Uri.parse('http://192.168.0.160:5000/upload'); // for emulator
