...
// import 'package:nichrome/pharma/capsule.dart';
// import 'package:nichrome/pharma/injectables.dart';
// import 'package:nichrome/pharma/oral_liquid.dart';
...
// import 'package:nichrome/pharma/granulation.dart';
                  ...
                  child: Column(
                    children: [
                      ...
                      if (searchController.text.isNotEmpty) ...[
                        ...
                        if (filteredMachines.isNotEmpty)
                          Expanded(
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                var machine = filteredMachines[index];
                                return ListTile(
                                  contentPadding: EdgeInsets.symmetric(vertical: 10, horizontal: 20),
                                  title: Text(
                                    machine.name,
                        ...
                        if (filteredIndustries.isEmpty && filteredMachines.isEmpty)
                          Center(
                            child: Text(
                              'No results found',
                      ...
                      // Show the SliderScreen if the search box is empty
                      if (searchController.text.isEmpty) Expanded(child: SliderScreen()),
                    ],
                  ),
                ),
              ),
