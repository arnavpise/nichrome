          ...
          child: Column(
            children: [
              ...
              Text(XTexts.changeYourPasswordTitle,
                  ...
                  textAlign: TextAlign.center),
              const SizedBox(height: XSizes.spaceBtwItems),
              Text(XTexts.changeYourPasswordSubTitle,
              ...
              SizedBox(
                width: double.infinity,
                child: TextButton(onPressed: () => ForgetPasswordController.instance.resendPasswordResetEmail(email), child: const Text(XTexts.resendEmail)),
              ),
            ],
          ),
        ),
